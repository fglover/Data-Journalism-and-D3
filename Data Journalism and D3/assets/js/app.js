...
d3.csv("assets/data/data.csv").then (function(infoData) {
    ...
    var xLinearScale = d3.scaleLinear()
        .domain([d3.min(infoData, d => d.poverty) - 1.25, d3.max(infoData, d => d.poverty)])
        .range([0, chartWidth]);
    
    var yLinearScale = d3.scaleLinear()
        .domain([d3.min(infoData, d => d.healthcare) - 2, d3.max(infoData, d => d.healthcare) + 1])
        .range([chartHeight, 0]);
